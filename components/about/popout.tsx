...
const Popout = () => {
  return (
    <section className="absolute left-2 right-2 top-24 z-[1000] flex h-auto w-auto items-center justify-center bg-white dark:bg-transparent md:left-1/2 md:top-2/3 md:h-[75vh] md:w-[90vw] md:-translate-x-1/2 md:-translate-y-2/3 ">
      <div className="animated-box1 flex h-auto w-auto flex-col gap-12 rounded-lg border border-cstmclr-200 pb-8 shadow-2xl dark:border-cstmclr-500 md:h-[65vh] md:w-[90vw] md:flex-row md:gap-0 md:p-8 md:pb-0 ">
        ...
        <div className="flex flex-col items-center justify-center gap-6 text-center md:w-3/5">
          <h3 className="text-2xl font-bold text-cstmclr-700 lg:text-3xl">
            ...
            <p className="mt-2 text-base text-cstmclr-300 dark:text-cstmclr-900">
              By Government Engineering College West Champaran
            </p>
            <p className="text-xs text-cstmclr-300 dark:text-cstmclr-900">
