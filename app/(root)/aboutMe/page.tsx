    ...
    <>
      ...
      >
        <button
          ...
          className="absolute right-4 top-24 flex items-center rounded-md border-2 border-cstmclr-400 bg-cstmclr-950 from-black to-gray-900 p-4
           text-xs font-bold text-cstmclr-50 hover:bg-black dark:border-cstmclr-400 dark:bg-gradient-to-r dark:hover:border-cstmclr-600 md:right-24 md:top-28 md:text-sm lg:right-36 lg:top-40 lg:text-base "
        >
        ...
        <div className="pt-20 md:pt-20 lg:ml-20 lg:pt-32">
          <h1 className=" text-3xl font-semibold text-cstmclr-900 dark:text-cstmclr-300 md:text-4xl lg:text-6xl">
            About Us
          </h1>
          <div className="mb-12 flex flex-col gap-4 py-8 pl-6 pr-6 text-justify font-mono text-xs text-cstmclr-700 dark:text-cstmclr-500 md:py-12 md:pl-16 md:pr-16 md:font-sans md:text-base lg:pr-24">
            <p>
              <span className="font-bold">Welcome!</span> I&apos;m a dedicated
              and versatile full stack web developer with{" "}
            ...
            <p>
              ...
              the time to understand each client&apos;s unique needs and
              translating them into code that drives real results. By staying
              up-to-date with the latest industry trends and best practices, I
              continuously improve my skills to ensure my clients get the most
              current, high-quality solutions.
            </p>

            <p>
              Whether you&apos;re a <span className="font-bold">startup</span>{" "}
              looking to create a standout product or an established company
              needing updates and optimizations, I&apos;m here to bring your
              vision to life with dedication, creativity, and a commitment to
